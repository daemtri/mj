...
type ProtoUser struct {
	...
	Longitude        *float32 `protobuf:"fixed32,26,req,name=longitude" json:"longitude,omitempty"`
	Latitude         *float32 `protobuf:"fixed32,27,req,name=latitude" json:"latitude,omitempty"`
	XXX_unrecognized []byte   `json:"-"`
}
...
func (m *ProtoUser) GetLongitude() float32 {
...
func (m *ProtoUser) GetLatitude() float32 {
