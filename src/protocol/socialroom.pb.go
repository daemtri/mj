...
type CEnterSocialRoom struct {
	...
	Longitude        *float32 `protobuf:"fixed32,4,req,name=longitude" json:"longitude,omitempty"`
	Latitude         *float32 `protobuf:"fixed32,5,req,name=latitude" json:"latitude,omitempty"`
...
func (m *CEnterSocialRoom) GetLongitude() float32 {
...
func (m *CEnterSocialRoom) GetLatitude() float32 {
...
type CCreatePrivateRoom struct {
	...
	Longitude        *float32 `protobuf:"fixed32,10,req,name=longitude" json:"longitude,omitempty"`
	Latitude         *float32 `protobuf:"fixed32,11,req,name=latitude" json:"latitude,omitempty"`
	XXX_unrecognized []byte   `json:"-"`
}
...
func (m *CCreatePrivateRoom) GetLongitude() float32 {
	if m != nil && m.Longitude != nil {
		return *m.Longitude
	}
	return 0
...
func (m *CCreatePrivateRoom) GetLatitude() float32 {
	if m != nil && m.Latitude != nil {
		return *m.Latitude
	}
	return 0
